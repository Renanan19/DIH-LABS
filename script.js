...
const translations = {
    fr: {
        ...
        nav_home: "Accueil",
        nav_purpose: "Notre Objet",
        nav_streamvision: "StreamVision",
        nav_sunday: "Sun Day",
        nav_golfswinganalyzer: "SmartCaddie",
        nav_activities: "Activités",
        nav_membership: "Adhésion",
        nav_contact: "Contact",
        hero_title: "L'innovation digitale,<br>façonnée par le collectif.",
        ...
        hero_btn_1: "Découvrir StreamVision",
        hero_btn_3: "Découvrir Sun Day",
        hero_btn_4: "Découvrir SmartCaddie",
        hero_btn_2: "Nous rejoindre",
        purpose_title: "Un ADN d'Expérimentation",
        ...
        activities_title: "Expertise & Moyens",
        ...
        membership_title: "Rejoindre le Lab",
        ...
        contact_desc: "Association (Loi 1901) fondée à Paris le 18/02/2026.",
        contact_address: "<strong>Siège social :</strong><br>31 Rue Linné, 75005 Paris",
        contact_title_right: "Connexion",
        contact_desc_right: "Des questions sur nos statuts ou nos projets ?",
        footer_copy: "&copy; 2026 DIH LABS | Laboratoire d'Innovation Digitale. Développé avec passion.",      
        footer_legal: "Informations Légales & Confidentialité",
        footer_press: "Espace Presse & Media Kit",
        modal_title: "Mentions Légales",
        modal_h1: "Éditeur du site",
        modal_p1: "Le site dih-labs.com est édité par l'association <strong>DIH</strong> (sigle DIH LABS), association déclarée régie par la loi du 1er juillet 1901.",
        modal_address: "<strong>Siège social :</strong> 31 Rue Linné, 75005 Paris.",
        modal_h2: "Hébergement",
        modal_p2: "Le site est hébergé par <strong>GitHub Inc.</strong><br>88 Colin P. Kelly Jr. Street<br>San Francisco, CA 94107, USA",
        modal_h3: "Propriété intellectuelle",
        modal_p3: "Tous les contenus présents sur le site (logos, textes, graphiques) sont la propriété exclusive de l'association DIH LABS, sauf mention contraire."
    },
    en: {
        ...
        nav_contact: "Contact",
        hero_title: "Digital innovation,<br>shaped by the collective.",
        ...
        hero_btn_1: "Discover StreamVision",
        hero_btn_3: "Discover Sun Day",
        hero_btn_4: "Discover SmartCaddie",
        hero_btn_2: "Join us",
        purpose_title: "An ADN of Experimentation",
        ...
        activities_title: "Expertise & Resources",
        ...
        membership_title: "Joining the Lab",
        ...
        contact_desc: "Association (Loi 1901) founded in Paris on 02/18/2026.",
        contact_address: "<strong>Registered office:</strong><br>31 Rue Linné, 75005 Paris",
        contact_title_right: "Connection",
        contact_desc_right: "Questions about our statutes or projects?",
        footer_copy: "&copy; 2026 DIH LABS | Digital Innovation Laboratory. Developed with passion.",
        footer_legal: "Legal Information & Privacy",
        footer_press: "Press Room & Media Kit",
        modal_title: "Legal Notice",
        modal_h1: "Site Publisher",
        modal_p1: "The site dih-labs.com is published by the association <strong>DIH</strong> (acronym DIH LABS), a declared association governed by the law of July 1, 1901.",
        modal_address: "<strong>Registered office:</strong> 31 Rue Linné, 75005 Paris.",
        modal_h2: "Hosting",
        modal_p2: "The site is hosted by <strong>GitHub Inc.</strong><br>88 Colin P. Kelly Jr. Street<br>San Francisco, CA 94107, USA",
        modal_h3: "Intellectual Property",
        modal_p3: "All content on the site (logos, texts, graphics) is the exclusive property of the DIH LABS association, unless otherwise stated."
    }
};
...
function setLanguage(lang) {
    ...
    // Update meta tags and head title
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (menuToggle && mainNav) {
        menuToggle.addEventListener('click', () => {
            ...
            // Update aria-label based on state and language
            const lang = document.documentElement.lang;
            if (isOpen) {
                menuToggle.setAttribute('aria-label', lang === 'fr' ? 'Fermer le menu' : 'Close menu');
            } else {
